...
class HandleMsgHdlBjlWebreq {
  ...
  public function processMessage($message) {
    ...
    $game = new \app\common\Game2msgHdlBjlCore();
    try {
...
//    \think\facade\Log::info(" reply_text ::" . $reply_text);
     log_Vardump(__METHOD__,"reply_text",$reply_text,"betlog");
...
////      \think\facade\Log::betnotice("ret params:" . json_encode($params));
      ...
      //tyhis if in web ,respose.create...
      //if in cmd env,just ret param json,,then use tlgrm api send..

      //$bot->sendMessage($chat_id, $reply_text, $game->parse_mode(), false, null, $message_id, $keyboard);
      $ret341=$this->apiRequestWebhook("sendMessage", $params);

      log_vardumpRetval(__METHOD__,$ret341, $GLOBALS['lgnm307']);
