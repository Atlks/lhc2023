...
//var_dump($varobj);
  ...
  function log_e_toGlbLog( $exception, string $meth, array $func_get_args) {
  ...
  function log_ex_toLibLog(string $meth,   $exception, $filFrg_libname) {
    log23::$filFrg_libname($meth, "e", $exception);
    $errFlg = $filFrg_libname . " ERR";
    log23::$errFlg($meth, "e", $exception);
  }

  function log_err_toLibLog(string $meth,   $exception, $filFrg) {
