...
async  function  http_get($url,opt)
{
  ...
  //  console.log("!!! FUN "+ivkFundbg);
    log_info(ivkFundbg)
    console.log(chalk.bgRed( chalk.blueBright("!!! FUN " + ivkFundbg) ))   ;
    ...
    try {
        ...
        if (!lasterr){
            ...
            console.log(chalk.bgRed( chalk.blueBright(">>>> [http_get] ret=>"+s ) ))   ;
...
//fetch("http://127.0.0.1:80/web/upload.php")
    ...
    // console.log(rzt110);
  //  console.log(chalk.bgYellow( chalk.greenBright(rzt110) ))   ;
 //   console.log("\r\n");
    return result;
}
